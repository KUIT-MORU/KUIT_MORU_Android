...
object DummyData {
    ...
    val dummyRoutines = listOf(
        ...
        Routine(10, "MORU 맞춤 루틴 1: 독서", "당신을 위한 맞춤 루틴입니다.", "https://images.unsplash.com/photo-1532012197267-da84d127e765?q=80&w=1887&auto=format&fit=crop", "독서", listOf("독서"), "MORU", null, 25, false, true, false),
        Routine(11, "MORU 맞춤 루틴 2: 운동", "당신을 위한 맞춤 루틴입니다.", "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&w=2070&auto=format&fit=crop", "운동", listOf("운동"), "MORU", null, 33, true, false, false),
        Routine(12, "MORU 맞춤 루틴 3: 명상", "당신을 위한 맞춤 루틴입니다.", "https://images.unsplash.com/photo-1593811167563-9d312357283d?q=80&w=1887&auto=format&fit=crop", "자기계발", listOf("명상", "아침"), "MORU", null, 41, false, false, false),
        Routine(13, "MORU 맞춤 루틴 4: 영어 공부", "당신을 위한 맞춤 루틴입니다.", "https://images.unsplash.com/photo-1455860922589-96865239906b?q=80&w=2070&auto=format&fit=crop", "학습", listOf("학습", "외국어"), "MORU", null, 29, false, true, false),
        Routine(14, "MORU 맞춤 루틴 5: 물 마시기", "당신을 위한 맞춤 루틴입니다.", "https://images.unsplash.com/photo-1541533267753-bab141444692?q=80&w=1887&auto=format&fit=crop", "건강", listOf("건강", "습관"), "MORU", null, 50, true, false, false),
        Routine(15, "MORU 맞춤 루틴 6: 블로그 글쓰기", "당신을 위한 맞춤 루틴입니다.", "https://images.unsplash.com/photo-1499750310107-5fef28a66643?q=80&w=2070&auto=format&fit=crop", "개발", listOf("개발", "글쓰기"), "MORU", null, 38, false, false, false),

        // "#지하철#독서" (tags.containsAll(listOf("지하철", "독서")))
        Routine(20, "출근길 지하철 독서", "이동 시간을 활용한 독서", null, "독서", listOf("독서", "지하철", "자기계발"), "지하철독서왕", "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d", 68, true, false, false),
        Routine(21, "퇴근길 웹소설 읽기", "하루의 마무리는 웹소설", null, "독서", listOf("독서", "지하철", "취미"), "웹소설매니아", null, 55, false, true, false),
        Routine(22, "지하철에서 기술 서적 읽기", "틈새 시간을 이용한 공부", null, "독서", listOf("독서", "지하철", "개발"), "공부하는개발자", null, 71, false, false, false),
        Routine(23, "지하철 오디오북 듣기", "눈이 피곤할 땐 오디오북", null, "독서", listOf("독서", "지하철", "오디오북"), "지하철독서왕", null, 49, true, true, false),
        Routine(24, "지하철 시집 읽기", "짧은 시간, 깊은 감동", null, "독서", listOf("독서", "지하철", "시"), "감성시인", null, 34, false, false, false),
        Routine(25, "지하철 신문 기사 읽기", "세상 돌아가는 소식", null, "독서", listOf("독서", "지하철", "뉴스"), "뉴스캐스터", null, 45, true, false, false),
        Routine(26, "지하철에서 전공 서적 예습", "수업 전 미리보는 전공", null, "독서", listOf("독서", "지하철", "전공"), "과탑", null, 62, false, true, false),

        // "#운동#명상" (tags.containsAll(listOf("운동", "명상")))
        Routine(30, "운동 후 5분 명상", "몸과 마음을 함께 단련", null, "운동", listOf("운동", "명상", "건강"), "헬창", "https://images.unsplash.com/photo-1548142813-c348350df52b", 91, true, false, false),
        Routine(31, "요가와 명상의 조화", "정적인 움직임 속의 평화", null, "운동", listOf("운동", "명상", "요가"), "요가마스터", null, 88, false, true, false),
        Routine(32, "아침 조깅 후 마무리 명상", "상쾌한 하루의 시작", null, "운동", listOf("운동", "명상", "아침"), "아침형인간", null, 79, true, true, false),
        Routine(33, "격렬한 운동 전 마인드셋 명상", "부상 방지와 집중력 향상", null, "운동", listOf("운동", "명상", "헬스"), "헬창", null, 67, false, false, false),
        Routine(34, "필라테스 후 호흡 명상", "몸의 정렬과 마음의 안정", null, "운동", listOf("운동", "명상", "필라테스"), "필라테스강사", null, 82, true, false, false)
    )
}